...
let examplearray = [
                    ...
                    ['2. We turn the heating on and wait a short while. The Hygrometer is now displaying: <span class="orange-highlight">10&deg;C and 74%RH</span>',  '5', 'Ventilation is always a good idea (and trickle vents should always be open), but the room is still too cold - it would be uncomfortable to sit in.'],
                    ...
                    ['4. The afternoon sun is shining into the room, keeping it at a toasty <span class="orange-highlight">24&deg;C</span>. You decide this is a good time to dry your laundry on a clothes horse.',  '4', 'Opening a window will allow the moisure that evaporates for the laundry to escape to the outside. An extractor fan is also a good idea if a window is not available.'],
